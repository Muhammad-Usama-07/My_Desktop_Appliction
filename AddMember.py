...
class AddMemberClass():
    ...
    def AddMemberFunc(self):
        ...
        member_validity_variable_entry = Entry( lf , textvariable = member_validity_variable , width = 25 , relief = "solid" ,
                                       font = ("Times%New%Roman" , 15 , "bold") )
        member_validity_variable_entry.place( x = 300 , y = 150 )

        member_telephoneNo_variable = IntVar()
        member_telephoneNo_variable_entry = Entry( lf , textvariable = member_telephoneNo_variable , width = 25 , relief = "solid" ,
                                           font = ("Times%New%Roman" , 15 , "bold") )
        ...
        Add_Member_button = Button( lf , text = "Add member" , bg = '#4dff4d' , font = ("Times%New%Roman" , 20 , "bold"),relief = "groove"
                              , command = MemberAdded )
        Add_Member_button.place( x = 120 , y = 350)

        Back_button = Button( lf , text = "Back" , bg = '#4dff4d' , font = ("Times%New%Roman" , 20 , "bold"), relief = "groove"
